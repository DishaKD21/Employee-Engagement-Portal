    ...
    <div className="min-h-screen bg-slate-50 px-6 py-10">
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        <div>
          ...
          <p className="mt-2 text-slate-600">Discover published events and register for the ones you want to attend.</p>
        </div>
        ...
        <Link href="/employee/events" className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:border-slate-300 hover:shadow-md">
          <h2 className="text-xl font-semibold text-slate-900">Browse Published Events</h2>
